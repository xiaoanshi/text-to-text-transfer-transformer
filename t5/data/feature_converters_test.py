...
class FeatureConvertersTest(tf.test.TestCase):
  ...
  def test_encoder_feature_converter_unpacked(self):
    x = {
    ...
    converted_ds = feature_converters.encoder_feature_converter(
        ds, sequence_length=sequence_length, pack=False, cls_id=8, mask_id=9)
  ...
  def test_encoder_feature_converter_packed(self):
    x = [{"inputs": [9, 9, 3, 4, 1], "targets": [7, 4, 3, 4, 1]},
    ...
    converted_ds = feature_converters.encoder_feature_converter(
        ds, sequence_length=sequence_length, pack=True, cls_id=8, mask_id=9)
